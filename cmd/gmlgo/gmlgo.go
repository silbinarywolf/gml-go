// I test this by running the following from the root dir:
// - go install -v ./cmd/gmlgo && gmlgo ./examples/spaceship
...
func main() {
	...
	for _, dir := range args {
		...
		if _, err := os.Stat(outputName); !os.IsNotExist(err) {
			...
			if len(input) == 0 {
				log.Printf("cannot generate %s as it's empty. rename or delete your %s file.\n", outputName, outputName)
				return
			}
